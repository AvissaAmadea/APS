...
<div class="container-fluid">
    <div class="row mt-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active fw-bold" aria-current="page">Daftar Pengajuan Pengembalian</li>
        </ol>
    </div>
    <div class="row">
        @if (session('status'))
                            ...
                            @foreach ($kembali as $key => $item)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center" style="width: 6rem">
                                        <a class="btn btn-info btn-sm" href="{{ route('pengembalian.opd.show', $item->id) }}" role="button"><i class="fa-solid fa-eye"></i></a>
