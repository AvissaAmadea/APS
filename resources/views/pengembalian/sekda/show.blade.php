                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-9">
                        <div class="form text-end">
                            ...
                            @if ($kembali->status_kembali === 'Menunggu Verifikasi')
                                <div class="form-group mb-2 row">
                                        ...
                                        <form action="{{ route('peminjaman.verifikasi', ['id' => $kembali->id]) }}" method="POST">
                                            ...
                                            <div class="form-group mb-2 row">
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="submit" name="status_kembali" value="Menunggu Pembayaran" class="btn btn-sm btn-primari">Menunggu Pembayaran</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            @elseif ($kembali->status_kembali === 'Menunggu Pembayaran')
                                <div class="form-group mb-2 row">
                                    <label for="status_kembali" class="col-md-4 col-form-label">Verifikasi :</label>
                                    <div class="col-md-8 text-start">
                                        <form action="{{ route('peminjaman.verifikasi', ['id' => $kembali->id]) }}" method="POST">
