...
<div class="container-fluid">
    <div class="row mt-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active fw-bold" aria-current="page">Pengguna Inactive</li>
        </ol>
    </div>
    <div class="row">
        @if (session('status'))
        ...
        <div class="card flex-fill border-0 p-2">
            <h6 class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a class="btn btn-secondary btn-sm" href="{{ route('user.index') }}" role="button"><i class="fa-solid fa-chevron-left pe-1"></i>Back</a>
                    <a class="btn btn-danger btn-sm" href="{{ route('user.delete') }}" role="button"><i class="fa-solid fa-trash pe-1"></i>All Delete</a>
                    <a class="btn btn-success btn-sm" href="{{ route('user.restore') }}" role="button"><i class="fa-solid fa-rotate-left pe-1"></i>All Restore</a>
                            ...
                            @foreach ($users as $key => $item)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-success btn-sm" href="{{ route('user.restore', $item->id) }}" role="button"><i class="fa-solid fa-rotate-left"></i></a>
                                        <a class="btn btn-danger btn-sm" href="{{ route('user.delete', $item->id) }}" role="button" onclick="return confirm('Yakin akan hapus data permanen?')"><i class="fa-solid fa-x"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
