                            ...
                            @foreach ($pinjams as $key => $item)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center" style="width: 6rem">
                                        <a class="btn btn-info btn-sm" href="{{ route('peminjaman.superadmin.showRiwayat', $item->id) }}" role="button"><i class="fa-solid fa-eye"></i></a>
                                        <a class="btn btn-warning btn-sm" href="{{ route('pengembalian.superadmin.create', $item->id) }}" role="button"><i class="fa-solid fa-file-signature"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
