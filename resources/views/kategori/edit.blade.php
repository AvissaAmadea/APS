...
<div class="container-fluid">
    <div class="row mt-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active fw-bold" aria-current="page">Edit Kategori</li>
        </ol>
    </div>
    <div class="row">
        <div class="card flex-fill border-0 p-1">
            ...
            <div class="card-body mx-2">
                <form class="form text-end" method="POST" action="{{ route('kategori.update', $kategori->id) }}">
                    @method('PATCH')
                    @csrf
                    <div class="form-group mb-2 row">
                        <label for="jenis" class="col-sm-2 col-form-label">Jenis Kategori</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('jenis') is-invalid @enderror" id="jenis" name="jenis" value="{{ $kategori->jenis }}" required autofocus>
                        </div>
                        @error('jenis')
