                            ...
                            @foreach ($asets as $key => $item)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-info btn-sm" href="{{ url('seeAset/opd/show', $item->id) }}" role="button"><i class="fa-solid fa-eye"></i></a>
                                        <a class="btn btn-warning btn-sm" href="{{ url('peminjaman/opd/create') }}" role="button"><i class="fa-solid fa-file-circle-plus"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
